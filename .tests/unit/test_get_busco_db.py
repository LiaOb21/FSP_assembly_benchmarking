...
def test_get_busco_db():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        # dbg
        print("/home/lobinu/git_repos/FSP_assembly_benchmarking/results_3/busco_db/048ds/busco_db.txt", file=sys.stderr)
        ...
        sp.check_output([
            ...
            "-m",
            "snakemake", 
            "/home/lobinu/git_repos/FSP_assembly_benchmarking/results_3/busco_db/048ds/busco_db.txt",
            "-f", 
            "-j1",
