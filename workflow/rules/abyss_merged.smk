...
rule abyss:
    ...
    shell:
        ...
        echo "abyss-pe -C {output.result_dir} name=abyss k={params.k} B={params.B} in='{input.unmerged_r1} {input.unmerged_r2}' se='{input.merged_in}' -j {threads} {params.optional_params}" >> {log} 2>&1
        abyss-pe -C {output.result_dir} name=abyss k={params.k} B={params.B} in='{input.unmerged_r1} {input.unmerged_r2}' se='{input.merged_in}' -j {threads} {params.optional_params} >> {log} 2>&1
